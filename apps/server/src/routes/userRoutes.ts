...
import { getAllAdmins, getAllStudents, getAllTeachers, getAllUsers, getUserDetails, loginUser, registerAdmin, registerStudent, registerTeacher } from '../controllers/userController';
